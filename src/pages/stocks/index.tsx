...
import { useRoqClient, useStockFindManyWithCount } from 'lib/roq';
...
export function StockListPage(props: StockListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useStockFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.stock.delete({ where: { id } });
      await mutate();
    } catch (error) {
