...
import { useStockCount, useOrderCount, useExpenseCount } from 'lib/roq';

import { FinanceChartListPage as ShowCaseList } from 'pages/finance-charts';

function DashboardPage() {
  const { session } = useSession();

  const stockStat = useStockCount();
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Finance Charts
                </Text>
                <NextLink href={`finance-charts`} passHref legacyBehavior>
                  <Button
