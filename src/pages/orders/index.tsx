...
export function OrderListPage(props: OrderListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['description.contains', 'buyer_contact.contains'],
          ...params.filters,
        },
        'order',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'buyer_contact', header: 'Buyer Contact', accessorKey: 'buyer_contact' },
    { id: 'is_paid', header: 'Is Paid', accessorKey: 'is_paid' },
    { id: 'is_delivered', header: 'Is Delivered', accessorKey: 'is_delivered' },
