  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Finance & Stock - Your one-stop platform for comprehensive financial management. Seamlessly track income, expenses, balances, and manage orders with intuitive controls and real-time updates."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmaW5hbmNlfGVufDB8fHx8MTY5NzU4OTQ0NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Finance & Stock - Your one-stop platform for comprehensive financial management. Seamlessly track income, expenses, balances, and manage orders with intuitive controls and real-time updates.`}
            </Text>
            <Box
